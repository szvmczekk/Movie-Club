package pl.szvmczek.movieclub.domain.rating;

import org.springframework.stereotype.Service;
import pl.szvmczek.movieclub.domain.movie.Movie;
import pl.szvmczek.movieclub.domain.movie.MovieRepository;
import pl.szvmczek.movieclub.domain.user.User;
import pl.szvmczek.movieclub.domain.user.UserRepository;
